...
//
//   regions = ['Northern','Northeastern','Western','Central','Eastern','Southern'];
//
//
//   // var countries = Object();
//   // countries['Northern'] = 'Chiang Rai|Chiang Mai|Nan|Phayao|Mae Hong Son|Lampang|Lamphun|Uttaradit';
//   // countries['Northeastern'] = 'Kalasin|Khon Kaen|Chaiyaphum|Nakhon Phanom	|Nakhon Ratchasima|Bueng Kan|Buri Ram|Maha Sarakham|Mukdahan|Yasothon|Roi Et|Loei|Si Sa Ket|Sakon Nakhon|Surin|Nong Khai|Nong Bua Lam Phu|Amnat Charoen|Udon Thani|Ubon Ratchathani';
//   // countries['Western'] = 'Kanchanaburi|Tak|Prachuap Khiri Khan|Phetchaburi|Ratchaburi';
//   // countries['Central'] = 'Bangkok|Kamphaeng Phet|Chai Nat|Nakhon Nayok|Nakhon Pathom|Nakhon Sawan|Nonthaburi|Pathum Thani|Phra Nakhon Si Ayutthaya|Phichit|Phitsanulok|Phetchabun|Lop Buri|Samut Prakan|Samut Songkhram|Samut Sakhon|Saraburi|Sing Buri|Sukhothai|Suphan Buri|Ang Thong|Uthai Thani';
//   // countries['Eastern'] = 'Chanthaburi|Chachoengsao|Chonburi|Trat|Prachinburi|Rayong|Sakaeo';
//   // countries['Southern'] = 'Krabi|Chumphon|Trang|Nakhon Si Thammarat|Narathiwat|Pattani|Phang Nga|Phattalung|Phuket|Yala|Ranong|Songkhla|Satun|Surat Thani';
//
//   for (var i = 0; i < regions.length; i++) {
//     $("#region").append('<option value="' + regions[i] + '">' + regions[i] + '</option>');
//   }
// }
// function set_city_state(oRegionSel, oCountrySel, oCity_StateSel) {
//   var countryArr;
//   oCountrySel.length = 0;
//   var region = oRegionSel.options[oRegionSel.selectedIndex].text;
//   if (countries[region]) {
//     oCity_StateSel.disabled = false;
//     oCity_StateSel.options[0] = new Option('SELECT COUNTRY', '');
//     city_stateArr = countries[region].split('|');
