    ...
    <div class="modal-dialog" style="top: 15%">    
      <div class="modal-content" style="height: auto; width: auto;">		
						<div class="container" style="padding: 15px 0px; border-radius: 5px; background-color: white; width: auto; height: 100%;">			      					
							<div class="row col-sm-12">
								<div class="couponPoint col-ms-2" id="disPoint" style="margin-left: 11px; color: red;"></div>
									<div class="couponStock col-sm-3" id="disStock" style=" color: blue; padding-bottom: 5%;"> </div>
							</div>
								<div class="row col-sm-12">
								<img src=" " class="img-circle col-sm-4" id="disIcon">
								...
								<div class="col-sm-12">
									<hr>
										...
										<div class="row col-sm-12" style="margin-left: 15px;">				
											<img src=" " class="col-sm-5" id="disImgContent" style="width: 190px; height: 190px;">
										<div class="couponDes col-sm-6" id="disDetail" style="margin-left: 5px; font-size: 13px;"> </div>
										</div>
							<div class="row col-sm-12" style="margin-top: 10%;">
								<div class="col-sm-offset-10">
									<button type="button" class="btn btn-primary" onclick="receivePoint();" style="box-shadow: 0 2px 8px rgba(0,0,0,0.3);">Redeem</button>
								</div>
							</div>
						</div>
     </div>
